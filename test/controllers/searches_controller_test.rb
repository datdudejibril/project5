...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search" do
    assert_difference('Search.count') do
      post searches_url, params: { search: { name: @search.name, search_text: @search.search_text } }
    end
  ...
  test "should update search" do
    patch search_url(@search), params: { search: { name: @search.name, search_text: @search.search_text } }
